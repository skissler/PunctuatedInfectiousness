...
\[ \text{Var}(\tau) \approx A + B (\sigma^{(1-\kappa)\alpha_{\text{total}}} - 1) \]

where $A$ depends on \dots, and $B$ depends on \dots. Thus, broad profiles ($\psi \rightarrow 1$) minimize $\text{Var}(W)$ and narrow profiles ($\psi \rightarrow 0$) maximize it. 
