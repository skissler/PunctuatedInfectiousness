...
Truncating the contact process tail has a second effect, however: it also reduces the variance of the contact process, which in turn reduces the overdispersion of the secondary infection distribution. It can be shown that the ratio of the truncated-to-original Negative Binomial overdispersion factors is 
\begin{equation}
	\frac{k_{\text{new}}}{k_{\text{old}}} = \frac{\mu_T^2/V_T}{k_c}
\end{equation}
This ratio (\ie, the relative difference between $k_{new}$ and $k_{old}$) is also mathematically invariant to $\psi$. However, if we introduce 
