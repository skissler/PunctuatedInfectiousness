...
# - Quantify forecastability across profiles (cf. predictability measures from
#   weather/climate literature)
# - How do dynamics differ under control scenarios or exogenous forcing
#   (seasonality, behavioural changes)?
# - The stepwise profile produces overdispersed secondary infections
#   (Poisson with random rate) — does this alone explain the differences, or
#   does the timing structure matter independently?
