...
# Generate contact levels from a pareto distribution and contact 
# Switch between draws of the pareto according to Poisson arrivals 

# compute the realized reproduction number for the uncontrolled epidemic (analytically)
...
# see if the predicted change in epidemic establishment probability bears out 